...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kpi-round.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPIROUND_LIST actions', async () => {
    ...
    it('dispatches FETCH_KPIROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KPIROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KPIROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KPIROUND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KPIROUND actions', async () => {
      const expectedActions = [
        {
