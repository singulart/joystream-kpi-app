...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kpi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPI_LIST actions', async () => {
    ...
    it('dispatches FETCH_KPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KPI actions', async () => {
      const expectedActions = [
        {
